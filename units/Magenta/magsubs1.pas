...
10 Aug 2010   - various cast fixed for D2009 and later
...
begin
    ...
    case OsInfo.dwPlatformId of
        ...
        begin
            ...
            begin
              // 10 Aug 2010 Vista and later reports editions with new API and literals
                ...
                begin
                  case ProductType of
                    PRODUCT_ULTIMATE: inf3 := ' Ultimate' ;
                    PRODUCT_PROFESSIONAL: inf3 := ' Professional' ;
                    PRODUCT_HOME_PREMIUM: inf3 := ' Home Premium' ;
                    PRODUCT_HOME_BASIC: inf3 := ' Home Basic' ;
                    PRODUCT_ENTERPRISE: inf3 := ' Enterprise' ;
                    PRODUCT_BUSINESS: inf3 := ' Business' ;
                    PRODUCT_STARTER: inf3 := ' Starter' ;
                    PRODUCT_CLUSTER_SERVER: inf3 := ' HPC Server' ;
                    ...
                    inf3 := ' Unknown ProductType ' + IntToStr (ProductType) ;
                  end;
                end;
